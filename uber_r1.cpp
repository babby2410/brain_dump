...
// It should have a method like scheduleMeeting(startTime, endTime) which returns any available room
// at that time and reserves it or an error if no rooms are available.
